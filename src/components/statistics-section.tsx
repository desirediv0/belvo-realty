                        ...
                        {[
                            ...
                            >
                                ...
                                <div className="relative z-10">
                                    ...
                                    <div className="text-4xl md:text-5xl  font-bold text-black mb-4 libreCaslonDisplay tracking-wider">
                    ...
                    <motion.div variants={itemVariants} className="text-center">
                        <div className="max-w-5xl mx-auto">
                            ...
                            <div className="mt-16 flex items-center justify-center space-x-8">
                                ...
                                <span className="text-black font-bold text-sm tracking-widest uppercase">PREMIUM LIVING</span>
                                <div className="w-16 h-px bg-black"></div>
                            </div>
                        </div>
                    </motion.div>
