                        ...
                        <motion.div variants={itemVariants} className="space-y-8">
                            <div className="space-y-6">
                                <motion.div variants={itemVariants} className="inline-block">
                                    <span className="px-4 py-2 bg-black text-white text-sm font-medium ">
                                        Flagship Project
                                    </span>
                                </motion.div>
                            ...
                            <motion.div variants={itemVariants}>
                                <motion.button
                                    ...
                                    whileTap={{ scale: 0.95 }}
                                    className="inline-flex items-center space-x-2 bg-neutral-900 text-white px-8 py-4 hover:bg-neutral-800 transition-colors duration-300 group"
                                >
